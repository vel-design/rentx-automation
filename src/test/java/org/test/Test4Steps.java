...
public class Test4Steps {
    ...
    public void chooseFirstSubcategory() {
        ...
        List<WebElement> labels = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(labelSelector));
    ...
    private void waitForDateStep() {
        ...
        WebElement dateInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input[name='start_date']")));
    ...
    public void pickTimeByText(String timeTextDesired) {
        ...
        for (WebElement btn : selects) {
            WebElement row = btn;
            try { row = btn.findElement(By.xpath("./ancestor::*[self::tr or self::li or self::div][1]")); } catch (Exception ignored) {}
    ...
    private void clearAndType(WebElement element, String text) {
        ...
        element.sendKeys(Keys.BACK_SPACE); // Remove selected text
    ...
    public void fillCustomerDetails(String first, String last, String email, String phone, boolean agreeTerms, String mainHandle) {
        debug("Filling customer details");
